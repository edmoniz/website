...
var menuTitles = ['PPOC Salon Submissions', 'Accreditation Gallery', 'Coastal Collection Folio', 
  'Egyptian Collection Folio', 'Poetry in Motion', 'Black and White']; // Simplified the titles

// common path prefix for the galleries
const contentPath = './';
